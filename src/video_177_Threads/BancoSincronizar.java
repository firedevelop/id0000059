...
class Banco{
	public Banco() {
		...
		// aqui le decimos que el cierrBanco tiene que establecerse en base a una condicion
	...
	public void transferencias(int cuentaOrigen,int cuentaDestino, double cantidad) throws InterruptedException {
		...
		while(cuentas[cuentaOrigen]<cantidad) {
			System.out.println("-------- SALDO INSUFICIENTE:" + cuentaOrigen + "....SALDO: " + cuentas[cuentaOrigen] + "..." + "cantidad");
			 //return;
			// aqui ponemos el hilo a la espera
		...
		// este metodo es el que informa a todos los await() para que despierten y vean si les vale ahora, las operaciones que tienen pendientes
	...
	// este metodo es el que se encargara de impedir que se ejecuten 2 hilos al mismo tiempo
	private Lock cierreBanco=new ReentrantLock();
	//aqui comprobaremos que haya saldo suficiente para realizar la transferencia y si no lo hay quedara await() hasta que sea posible realizar dicha transferencia
